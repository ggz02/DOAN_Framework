<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="DoAn_Demo.WebForm1" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:SqlDataSource ID="n1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionStringKFC %>" SelectCommand="SELECT * FROM [DDH]"></asp:SqlDataSource>
        </div>
    </form>
</body>
</html>
