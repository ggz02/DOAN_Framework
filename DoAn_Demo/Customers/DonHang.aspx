<%@ Page Title="" Language="C#" MasterPageFile="~/Master_2.Master" AutoEventWireup="true" CodeBehind="DonHang.aspx.cs" Inherits="DoAn_Demo.DonHang" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page_top wrapper_donhang" style="color: #0033CC;">
        ...
        <div class="container text-center">
            ...
            <asp:GridView ID="dtgvDonHang" runat="server"
                ...
                <Columns>
                    ...
                    <%-- Đơn giá --%>
                    <asp:BoundField DataField="Gia" HeaderText="Đơn Giá" DataFormatString="{0:0,000 VNĐ}">
                        <HeaderStyle Width="80px" HorizontalAlign="Center" />
                    </asp:BoundField>
        ...
        <%-- Đơn giá --%>
        <asp:Label CssClass="lblTongTien" ID="lblTongTien" runat="server" ForeColor="#333333" Style="font-size: 18px; font-weight: bold"></asp:Label>
        <br />
        <br />
        <h3 style="text-align: center; color: #000; font-weight: 600; margin-bottom: 30px; margin-top: 30px;">THÔNG TIN NGƯỜI NHẬN</h3>
        <div class="edit-form-ddh">
            ...
            <table class="table_info">
                <tr>
                    ...
                    <td>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" CssClass="error_message" ControlToValidate="txtHoTen" ErrorMessage="Nhập họ tên!" Font-Size="Small"></asp:RequiredFieldValidator>
                ...
                <tr>
                    <td colspan="3" style="text-align: center; padding-top: 25px;">
                        <asp:Button ID="butDongY" runat="server"
                            ...
                            Style="font-size: small" Width="220px"
