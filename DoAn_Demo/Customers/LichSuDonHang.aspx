<%@ Page Title="" Language="C#" MasterPageFile="~/Master_2.Master" AutoEventWireup="true" CodeBehind="LichSuDonHang.aspx.cs" Inherits="DoAn_Demo.Customers.LichSuDonHang" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <SortedDescendingHeaderStyle BackColor="#15524A" />
        ...
        <%--<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionStringKFC %>" SelectCommand="SELECT * FROM [LICHSUDONHANG]"></asp:SqlDataSource>--%>
    </div>
</asp:Content>
