<%@ Page Title="" Language="C#" MasterPageFile="~/Master_2.Master" AutoEventWireup="true" CodeBehind="GuiDonHang.aspx.cs" Inherits="DoAn_Demo.GuiDonHang" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page_top wrapper_guidonhang">
        ...
        <div class="content_guidonhang">
            <asp:Image CssClass="guihang_img" ID="Image1" runat="server" ImageUrl="~/img/ThanksKFC.jpg" />
